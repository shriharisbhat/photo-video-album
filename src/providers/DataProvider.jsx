...
const PHOTOS_URL = "https://api.pexels.com/v1/search?per_page=50&query=";
const VIDEOS_URL = "https://api.pexels.com/videos/search?per_page=50&query=";
